...
public class AnimateProcessButton extends ProcessButton {
    ...
    public AnimateProcessButton(Context context) {
        super(context);
        init(context);
    }

    public AnimateProcessButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AnimateProcessButton(Context context, AttributeSet attrs, int defStyle) {
