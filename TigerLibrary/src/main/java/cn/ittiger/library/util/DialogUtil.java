...
public class DialogUtil {
    ...
    public static Dialog showSingleChoiceDialog(Context context, String title, String[] items, int defaultChecked, DialogInterface.OnClickListener itemClickListener) {

        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(context);
        alertBuilder.setTitle(title);
        alertBuilder.setSingleChoiceItems(items, defaultChecked, itemClickListener);
